...
/**
 * Created by Vijilesh on 5/10/2015.
 */
 ...
 */
public class HomeLoaderCallback implements LoaderManager.LoaderCallbacks<Cursor> {

    Context mContext;

    public static final String QUERY_KEY = "ActivityQuery";

    public static final String TAG = "HomeLoaderCallback";

    public HomeLoaderCallback(Context context) {
        mContext = context;
    }
    ...
    public void onLoadFinished(Loader<Cursor> arg0, Cursor cursor) {
        TextView tv = null;// (TextView) ((Activity)mContext).findViewById(R.id.sample_output);
        if (tv == null) {
